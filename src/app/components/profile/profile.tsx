import { githubData, jobInfo, userApplication, userDataInterface } from "@/interfaces/interface";
...
export default async function Profile({userData}: {userData: userDataInterface}) {

if(!userData) return <h1>Error</h1>
  return (
